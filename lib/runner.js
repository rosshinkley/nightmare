...
app.on('ready', function() {
    ...
    parent.on('javascript', function(src) {
        parent.emit('log', renderer.getMaxListeners());
        parent.emit('log', renderer.listeners('error').length);
        parent.emit('log', renderer.listeners('log').length);
        parent.emit('log', renderer.listeners('response').length);
