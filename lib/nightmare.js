...
var electron_stdout = require('debug')('electron:stdout');
var electron_stderr = require('debug')('electron:stderr');
/**
 * Module dependencies
 */
...
function Nightmare(options) {
  ...
  this.proc.stdout.on('data', function(data){
    electron_stdout(data.toString());
  });

  this.proc.stderr.on('data', function(data){
    electron_stderr(data.toString());
  });
